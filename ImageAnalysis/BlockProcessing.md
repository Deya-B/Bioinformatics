...
> $m$ y $n$ indican las dimensiones del bloque a procesar `fun` es un enlace a una función que: - acepta como entrada una matriz $x$ (de dimensiones $m$ y $n$) - devuelve una matriz, vector o escalar y, donde: $y = fun(x)$
>
...
Original: <img src="\images\Skin_gray.jpg"/>

Procesada: <img src="\images\Skin_gray_processed.jpg"/>
